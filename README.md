...
<div>
  <a href="https://discord.gg/Fu3k65f2k3">
    <img src="https://img.shields.io/discord/1346225185166065826?logo=discord&logoColor=white&label=Join+Us&color=blueviolet" alt="Discord">
  </a>
</div>
</div>
...
- **Tools**: Tools are any external tool that an agent can use. They are defined as Kubernetes custom resources and can be used by multiple agents.
