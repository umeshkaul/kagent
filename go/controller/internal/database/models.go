...
// BaseModel contains common fields for all database tables
...
type Team struct {
	BaseModel
	Component JSONMap `gorm:"type:json;not null" json:"component"`
}

// Session represents a conversation session
type Session struct {
	BaseModel
	TeamID    *uint   `gorm:"index;constraint:OnDelete:CASCADE" json:"team_id,omitempty"`
	TeamState JSONMap `gorm:"type:json" json:"team_state,omitempty"`
...
type Run struct {
	...
	Messages     JSONMap   `gorm:"type:json" json:"messages"`
...
// Gallery represents a gallery configuration
type Gallery struct {
	BaseModel
	Config JSONMap `gorm:"type:json;not null" json:"config"`
}
...
type EvalRun struct {
	...
	RunnerConfig    JSONMap       `gorm:"type:json;not null" json:"runner_config"`
	JudgeConfig     JSONMap       `gorm:"type:json;not null" json:"judge_config"`
	CriteriaConfigs JSONMap       `gorm:"type:json" json:"criteria_configs"`
